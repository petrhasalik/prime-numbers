...
module.exports = function (grunt) {
  ...
  // Ammount of time that tasks will take.  This can help when optimizing build times
  ...
  grunt.initConfig({
        ...
        options: {
          ...
          callback: function (nodemon) {
            ...
            nodemon.on('config:update', function () {
              setTimeout(function () {
                require('open')('http://localhost:8888/debug?port=5858');
              }, 500);
            });
          }
        }
    ...
    usemin: {
      ...
      options: {
        ...
        //Update image references in our ng-templates
        patterns: {
          js: [
  ...
  // Used to delay livereload until the server is restarted
  ...
  grunt.registerTask('daemon', function(target) {
